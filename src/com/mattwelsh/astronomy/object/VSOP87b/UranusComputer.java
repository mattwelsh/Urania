...
import com.mattwelsh.astronomy.object.VSOP87b.uranus.UranusLbrDataReader;
 ...
 * Uranus with respect to equinox J2000 using VSOP87 Series Version B. This series should have an
 ...
 * @since 1.0
 */
public class UranusComputer extends PlanetaryComputer {
  ...
  protected void initializeDataReader() {
    this.dataReader = new UranusLbrDataReader(this.t);
  }
}