...
import com.mattwelsh.astronomy.object.VSOP87b.jupiter.JupiterLbrDataReader;
 ...
 * Jupiter with respect to equinox J2000 using VSOP87 Series Version B. This series should have an
 ...
 * @since 1.0
 */
public class JupiterComputer extends PlanetaryComputer {
  ...
  protected void initializeDataReader() {
    this.dataReader = new JupiterLbrDataReader(this.t);
  }
}
