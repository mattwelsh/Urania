...
public class SiteTest {
  ...
  public void getGeographicalLatitude() {
    ...
    org.junit.Assert.assertEquals(siteTwo.getGeographicalLatitude(), 50.79861, 0.0001);
  }
  ...
  public void getGeocentricLatitude() {
    ...
    org.junit.Assert.assertEquals(siteTwo.getGeocentricLatitude(), 50.60998, 0.0001);
  }

  @Test
  public void getRhoSinPhiPrime() {
    org.junit.Assert.assertEquals(siteOne.getRhoSinPhiPrime(), 0.5468607803375676, 0.0);
    org.junit.Assert.assertEquals(siteTwo.getRhoSinPhiPrime(), 0.771306, 0.0000001);
  }

  @Test
  public void getRhoCosPhiPrime() {
    org.junit.Assert.assertEquals(siteOne.getRhoCosPhiPrime(), 0.8363392448202929, 0.0);
    org.junit.Assert.assertEquals(siteTwo.getRhoCosPhiPrime(), 0.63333, 0.0001);
  }
