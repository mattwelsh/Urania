 ...
 *
 * and were evaluated in Maple 2017
 *
 * or hand checked at
 *
...
public class EspenakMeeusDeltaTTest {
  ...
  public void getDeltaT() {
    ...
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 18720.48, 4.0);
    ...
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 50.19401599, 1.0);

    jd1 = new JulianDate(1750, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 13.37007027, 1.0);

    jd1 = new JulianDate(1850, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 7.1069000, 1.0);

    jd1 = new JulianDate(1875, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), -3.087638362, 1.0);

    jd1 = new JulianDate(1910, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 10.3884000, 1.0);

    jd1 = new JulianDate(1930, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 24.1329000, 1.0);

    jd1 = new JulianDate(1957, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 31.84336781, 1.0);

    jd1 = new JulianDate(1964, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 35.10137583, 1.0);

    jd1 = new JulianDate(1997, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 62.31352058, 1.0);

    jd1 = new JulianDate(2019, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 69.1416080, 4.0);

    jd1 = new JulianDate(2060, 1, 1, 12, 0, 0);
    org.junit.Assert.assertEquals(calc.getDeltaT(jd1), 113.0, 1.0);
